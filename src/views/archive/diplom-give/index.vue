...
const apiData: {
  ...
  diplom_category_id: number | null;
  data: any[];
  links: [];
  students: [];
  current_page: number;
      ...
      <div class="card-body">
        <div class="panel-header">
          ...
          <div class="panel-toggles">
            <router-link :to="{ path: '/archive/diplom-give/' + 'create' }">
      ...
      <div class="card-body">
        <div v-if="apiData.data.length" class="table-responsive">
          <table class="content-table">
            ...
            <tbody>
              <tr class="table-row-gived" v-for="(element, index) in apiData.data" :key="element.id">
                <td>
                  {{
                ...
                <td>
                  <div>
                    <a @click="downloadDiplom(element.id)" class="btns c-save py-1.5 px-4 w-100 d-inline-block mb-2">
                      <i class="mdi mdi-download font-size-14 align-middle me-1"></i>{{ $t("Diploma") }}
                    </a>
                    <a @click="downloadSupplement(element.id)" class="btns c-save py-1.5 px-4 w-100 d-inline-block">
                      <i class="mdi mdi-download font-size-14 align-middle me-1"></i>{{ $t("Print_Supplement") }}
                    </a>
                  </div>
                </td>
                <td>
...
.table-row-gived {
  ...
  width: 100% !important;
  grid-gap: 0;
  grid-template-columns: 40px auto 140px 140px 150px 200px 160px 120px;

  @include mobile() {
    grid-template-columns: 70px auto 250px 140px 120px;
  }
}
</style>
