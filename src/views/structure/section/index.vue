<template>
  <div pagetitle="`Bo'lim`" class="division-page">
          ...
          <div class="row">
            <div class="my-2 col-xl-5 form--item">
              <a-space>
                <a-select
                  v-model:value="value"
                  :options="allDate.optionsDivisionType"
                  @change="handleChange"
                >
                </a-select>
              </a-space>
              <label for="yu">Bo'linma turini tanlang</label>
            </div>
            <div class="my-2 col-xl-5 form--item">
              ...
              <table class="content-table">
                ...
                <tbody>
                  <tr
                    ...
                    v-for="element in allTables.tableDivision"
                    :key="element.id"
                  >
                    <td>{{ element.id }}</td>
                    <td>
