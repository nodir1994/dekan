<template>
  <div pagetitle="`Uslubiy nashr qo'shish`" class="createPublicationPage">
    <!-----------START PAGE LIST HEADER TOP ------------------------>
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">
            <router-link to="/scientific-activity/publication-methodical"
              >Uslubiy nashrlar /
            </router-link>
            Uslubiy nashr qo'shish
          </h5>
              ...
              <div class="row">
                ...
                >
                  ...
                  <a-select
                    ...
                    @change="handleChange"
                    placeholder="Uslubiy nashr turini tanlang"
                  >
                  </a-select>
                </a-form-item>
                ...
                >
                  ...
                  <a-input v-model:value="formCreateOrder.number" />
                </a-form-item>
