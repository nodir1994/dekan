<template>
  <div pagetitle="'Malaka oshirish'" class="scientificalCheckPage">
          ...
          <table class="content-table">
            ...
            <tbody>
              ...
              >
                ...
                <td>
                  {{ element.checkedAuthor }}
                </td>
                <td>
                  {{ element.updateData }} <br />
                  {{ element.updateTime }}
                </td>
                <td class="gridjs-td">
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                      ...
                      >
                        <i class="far fa-eye font-size-16 b-actions c-see"></i
                      ></a>
                    </li>
                  </ul>
                </td>
...
<style lang="scss">
.scientificalCheckPage {
  .table-row {
    display: grid;
    width: 100% !important;
    grid-gap: 0;
    grid-template-columns: 50px auto 180px 80px 90px 180px 170px 100px 100px 60px 60px;
    @include mobile() {
      grid-template-columns: 50px 200px 180px 80px 90px 180px 170px 100px 100px 60px 60px;
    }
  }
  .table-row-modal {
    width: 100% !important;
