<template>
  <div pagetitle="'Int.mulk (tasdiqlash)'" class="propertyPage">
    <!-----------START PAGE LIST HEADER TOP ------------------------>
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">Intelektual mulklar</h5>
          <div class="panel-toggles">
            <div class="filterBlock">
              <router-link
                to="/scientific-activity/publication-property/id"
                class="btns c-save py-1.5 px-4 me-3 d-inline-block"
              >
                <i class="mdi mdi-plus font-size-14 align-middle me-1"></i>Kiritish
              </router-link>
              <router-link
                to="/scientific-activity/publication-property/add"
                class="btns c-save py-1.5 px-4 me-3 d-inline-block"
              >
          ...
          <div class="row">
            ...
            <div class="my-2 col-md-3 form--item">
              <a-space>
                <a-select
                  v-model:value="value"
                  :options="allDate.optionsProperty"
                  @change="handleChange"
                >
                </a-select>
              </a-space>
              <label for="yu">Int. mulk turi</label>
            </div>
...
.propertyPage {
  .table-row {
    ...
    width: 100% !important;
    grid-gap: 0;
    grid-template-columns: 50px auto 180px 130px 150px 180px 100px 70px 60px;
    @include mobile() {
