<template>
  <div pagetitle="`Ilmiy nashr qo'shish`" class="createPublicationPage">
    <!-----------START PAGE LIST HEADER TOP ------------------------>
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">
            <router-link to="//scientific-activity/publication-scientifical"
              >Ilmiy nashrlar /
            </router-link>
            Ilmiy nashr qo'shish
          </h5>
              ...
              <div class="row">
                ...
                >
                  ...
                  <a-select
                    ...
                    @change="handleChange"
                    placeholder="Ilmiy nashr turini tanlang"
                  >
                  </a-select>
                </a-form-item>
                ...
                >
                  ...
                  >
                  <a-select
                    v-model:value="formCreateOrder.language"
                ...
                >
                  <label for="division-name-input" class="form-label"
                    >Doi</label
                  >
                  <a-input v-model:value="formCreateOrder.doi" />
                </a-form-item>
                ...
                >
                  <label for="division-name-input" class="form-label"
                    >Manba (jurnal) nomi</label
                  >
                  <a-input v-model:value="formCreateOrder.journalName" />
                </a-form-item>
                ...
                >
                  ...
                  <a-input v-model:value="formCreateOrder.parametrs" />
                </a-form-item>
                ...
                >
                  <label for="division-name-select" class="form-label"
                    >Xalqaro ilmiy bazalar</label
                  >
                  <a-select
                    v-model:value="formCreateOrder.scienPlatform"
                    :options="allDate.optionsScientificPlatform"
                    style="width: 100%; border-radius: 10px !important"
                    @change="handleChange"
                    placeholder="Nashr yilini tanlang"
                  >
                  </a-select>
                </a-form-item>
                ...
                >
                  ...
                  >
                  <a-select
                    v-model:value="formCreateOrder.yearNashr"
