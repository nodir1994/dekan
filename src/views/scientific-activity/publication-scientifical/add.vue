<template>
  <div pagetitle="`Ilmiy nashrlar ro'yxatri`" class="addPubScinPage">
...
.addPubScinPage {
  .table-row {
    ...
    width: 100% !important;
    grid-gap: 0;
    grid-template-columns: 40px 50px auto 200px 100px 150px 180px 200px 60px;
    @include mobile() {
