    ...
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">Dars jadvalini ko'rish</h5>
          ...
          <table class="content-table">
            ...
            <tbody>
              <tr
                ...
                v-for="(element, index1) in allTables.tableCurriculum"
                :key="index1"
              >
                <td>
                  {{ element.name }}
                ...
                <td>
                  <router-link to="/curriculum/schedule-list/schedule">
                    {{ element.group }}
                  </router-link>
                </td>
                <td>
                ...
                <td>
                  <div v-for="(week, index) in element.weeks" :key="index">
                    <span
                      :class="
                        week.numberOfLesson != 0 ? 'actions-h' : 'actions-r'
                      "
                      class="btns1"
                    >
                      №{{ index + 1 }} {{ week.numberOfLesson }}
                    </span>
                  </div>
                </td>
              </tr>
