<template>
  <div pagetitle="'Reyting'" class="examMidternGradePage">
    <!-----------START PAGE LIST HEADER TOP ------------------------>
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">
            <router-link to="/teacher/midterm-exam-table"
              >Nazorat jadvali
            </router-link>
            / Reyting
          </h5>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th style="min-width: 100px">Top. bali</th>
                    <th style="min-width: 100px">Ball [5]</th>
                  </tr>
                  <tr
