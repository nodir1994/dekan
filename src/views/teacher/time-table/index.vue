<template>
  <div pagetitle="'Xaftaliklar'" class="timeTablePage">
    ...
    <div class="collapse__block">
      <b-collapse visible id="collapse-3">
        <b-card>
          <div class="row">
            <div class="my-2 col-md-11 form--item">
              <a-space>
                <a-select
                  v-model:value="value"
            ...
            <div class="my-2 col-md-1">
              <router-link to="/curriculum/info-schedule/schedule">
                <button class="btn-search c-save">OK</button></router-link
              >
            </div>
          </div>
        </b-card>
              ...
              <ul class="calendar__content">
                ...
                >
                  ...
                  <div class="calendar-day-content">
                    <ul class="sessons">
                      <router-link to="/teacher/time-table/check-lesson">
                        <li
                ...
                <div class="col-md-6">
                  ...
                  >
                    <label for="division-name-input" class="form-label"
                      >Qo'shimcha</label
                    >
                    <a-input v-model:value="previousEducationSeriaDocument" />
                  </a-form-item>
