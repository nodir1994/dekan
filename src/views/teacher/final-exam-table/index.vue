              ...
              <table class="content-table">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>{{ element.exsamType2 }} | {{ element.qaydnoma }}</td>
                    <td>
                      {{ element.lessonPair }}
                    </td>
                    <td>
                      ...
                      <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                          <div class="edit__project">
                            <router-link
                              to="/teacher/final-exam-table/check-lesson"
...
.examMidternPage {
  .table-row-dak {
    ...
    width: 100% !important;
    grid-gap: 0;
    grid-template-columns: 50px 100px 100px 100px 120px auto 250px 110px 110px 60px;
    @include mobile() {
