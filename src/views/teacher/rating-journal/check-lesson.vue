<template>
  <div pagetitle="'Malaka oshirish'" class="chechGradePage">
    <!-----------START PAGE LIST HEADER TOP ------------------------>
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">
            <router-link to="/teacher/rating-journal"
              >Baholash jurnali
            </router-link>
            <router-link to="/teacher/rating-journal/journal"
              >/ Fan baholari
            </router-link>
          ...
          <div class="filterBlock">
            <router-link
              to="/teacher/rating-journal/journal"
...
.chechGradePage {
  .table-row {
    ...
    @include mobile() {
      grid-template-columns: 40px 200px 120px;
    }
    th,
    td {
      &:nth-last-child(1) {
