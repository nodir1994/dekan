    ...
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">Dars o'tish</h5>
              ...
              <table class="content-table">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td :class="element.lessonDate.status? 'text-success': 'text-danger'">
                      ...
                      <ul class="list-inline mb-0">
                        <li class="list-inline-item">
                          <div class="edit__project">
                            <router-link
                              to="/teacher/training-list/check-lesson"
...
.dakPage {
  .table-row-dak {
    ...
    width: 100% !important;
    grid-gap: 0;
    grid-template-columns: 50px 100px 100px 100px 100px auto 110px 110px 110px 220px 60px;
    @include mobile() {
      grid-template-columns: 50px 100px 100px 100px 200px 100px 110px 110px 110px 220px 60px;
    }
  }
  .content-table {
    th,
