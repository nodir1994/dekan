...
import {
  ...
  getCommandList,
  createFinish,
} from "@/utils/api/student-action/finish";
...
<template>
  <div pagetitle="'Akademik tatil'" class="transfer-finish-page">
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 class="card-title">{{ $t("Transfer_Graduate") }}</h5>
        ...
        <b-card>
          <form class="row" @submit.prevent="onSearch">
            ...
            <div class="col-xl-3 form--item">
              <div class="my-2" name="nameFaculty">
                <a-select :filter-option="helpers.filterOptionByName" show-search allow-clear
                  :disabled="!apiData.edu_plan_id" v-model:value="apiData.academic_year_id"
          ...
          <div class="card-body">
            <a-form>
              ...
              <div class="d-flex justify-content-end">
                <button @click="attachData" :disabled="!apiData?.students?.length || !apiData.command_id"
