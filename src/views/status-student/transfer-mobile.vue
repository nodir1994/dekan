...
import {
  ...
  getOrderList,
  postMobile,
} from "@/utils/api/student-action/mobile";
...
<template>
  <div pagetitle="'Akademik mobillik'" class="transfer-mobile-page">
    <!-----------START PAGE LIST HEADER TOP ------------------------>
    <div class="card panel-header-bg">
      <div class="card-body">
        <div class="panel-header">
          <h5 style="padding: 7px 0" class="card-title">
            {{ $t("Transfer_Academic_Mobile") }}
          </h5>
        </div>
      </div>
    </div>
          ...
          <div class="card-body">
            <div class="mb-3" name="nameFaculty">
              ...
              <a-select :filter-option="helpers.filterOptionByName" show-search allow-clear
                ...
                :options="sideFormOptions.typeMobileOptions" placeholder="Mobillik toifasini tanlang">
              </a-select>
            </div>
            <div class="mb-3" name="nameFaculty">
              <label for="division-name-select" class="form-label">{{
            ...
            <div class="d-flex justify-content-end">
              <button class="btns c-save" type="button" :disabled="!apiData?.students?.length || !apiData.reference_id"
